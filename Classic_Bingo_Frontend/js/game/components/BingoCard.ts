...
export class BingoCardComponent {
    ...
    private getBallColor(column: string): string {
    ...
    render(card: BingoCardType, cardIndex: number): string {
    ...
    const cell = document.querySelector(`[data-card-id="${cardId}"][data-cell="${cellIndex}"]`) as HTMLElement;
