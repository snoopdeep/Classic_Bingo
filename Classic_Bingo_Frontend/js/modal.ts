...
export interface ModalOptions {
    title?: string;
    message: string;
    type?: 'login' | 'alert' | 'confirm' | 'profile' | 'settings' | 'login-manual';
    onConfirm?: () => void;
    onCancel?: () => void;
    profileData?: any;
}
...
class ModalManager {
    ...
    private currentType: string = 'alert';
    private loginCallback: ((userId: string) => Promise<{ success: boolean; error?: string }>) | null = null;
    private logoutCallback: (() => Promise<void>) | null = null;
    
    public setLoginCallback(callback: (userId: string) => Promise<{ success: boolean; error?: string }>): void {
        this.loginCallback = callback;
    }
    
    public setLogoutCallback(callback: () => Promise<void>): void {
    ...
    private showLoginModal(message: string): void {
        this.init();
    ...
    private showProfileModal(data: any): void {
        this.init();
        ...
        if (this.modal) {
            ...
            const copyButton = document.getElementById('copy-user-id-btn') as HTMLButtonElement;
            const userIdElement = document.getElementById('profile-user-id') as HTMLElement;
    ...
    public show(options: ModalOptions | string): void {
        this.init();
        ...
        this.showManualLoginModal(options as ModalOptions); 
        return;
    }
    ...
    private async handleLogin(): Promise<void> {
        ...
        const loginBtn = document.getElementById('modal-login-btn') as HTMLButtonElement;
    ...
    private showManualLoginModal(options: ModalOptions): void {
    this.init();
...
private async handleManualLogin(): Promise<void> {
    const userIdInput = document.getElementById('modal-manual-userId') as HTMLInputElement;
    const loginBtn = document.getElementById('modal-manual-login-btn') as HTMLButtonElement;
    ...
    if (result.success) {
        ...
        this.show({ 
            ...
            onConfirm: () => {
                ...
                const manualLoginBtn = document.getElementById('modal-manual-login-btn') as HTMLButtonElement;
                if (manualLoginBtn) {
